...
import 'package:news_app/api/retrofit-services.dart';
...
class _CategoryDetailsState extends State<CategoryDetails> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: RetrofitServices(Dio()).getSources(ApiConstant.apiKey,widget.category.id),
        builder: (context, snapshot) {
          //todo:loading
          if(snapshot.connectionState == ConnectionState.waiting) {
            return Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(onPressed: (){
                    RetrofitServices(Dio()).getSources(ApiConstant.apiKey,widget.category.id);
                    setState(() {
