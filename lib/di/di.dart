...
SourceRepository  injectionSourceRepository(){
  return SourceRepositoryImpl(remoteDataSource: injectionSourceRemoteDataSources());

}
 SourceRemoteDataSource injectionSourceRemoteDataSources(){
  return SourceRemoteDataSourceImpl(apiManager: injectionApiManager());
}
...
NewsRemoteDataSources injectionNewsRemoteDataSources(){
  return NewsRemoteDataSourcesImpl(apiManager: injectionApiManager());
}
